...
class Booking(models.Model):
    ...
    meal = models.ForeignKey(MealPlan, on_delete=models.PROTECT)
...
class BookingStaging(models.Model):
    ref_id = models.IntegerField(primary_key=True)
    res_id = models.IntegerField()
    ...
    status4 = models.CharField(max_length=3)
    status5 = models.CharField(max_length=3)
    is_charter = models.BooleanField(default=False, blank=True, null=True)
